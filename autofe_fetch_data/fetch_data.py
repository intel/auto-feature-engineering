...
def fetch_data(dataset_path, is_train):
    output_dir = "output/"
    ...
    if is_train:
        to_save = os.path.join(output_dir, "train_sample.parquet")
    else:
        to_save = os.path.join(output_dir, "test_sample.parquet")
...
def parse_args():
    ...
    parser.add_argument('--url', type=str, default='sample.csv', help='url used to fetch your data')
    parser.add_argument('--usage', type=str, default='train', help='url used to fetch your data')
