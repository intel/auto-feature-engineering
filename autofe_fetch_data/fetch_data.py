...
def fetch_data(cfg):
    ...
    if usage == "combined":
        to_save = os.path.join(output_dir, "dataset.parquet")
    elif usage == "train":
...
def parse_args():
    ...
    parser.add_argument('--usage', type=str, default='combined', help='url used to fetch your data, available options are combined, train and test')
